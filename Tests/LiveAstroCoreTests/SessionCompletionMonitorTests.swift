...
final class SessionCompletionMonitorTests: XCTestCase {
    ...
    func testIdleNotElapsed() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T22:10:00-04:00"), plannedStopAnchor: d("2026-08-07T21:00:00-04:00"),
    ...
    func testIdleElapsedFiresSafeguard() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T22:16:00-04:00"), plannedStopAnchor: d("2026-08-07T21:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-07T22:00:00-04:00"), settings: settings(mins: 15),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .safeguard)
    }
    func testIdleElapsedButAlreadyFiredStaysNone() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T22:30:00-04:00"), plannedStopAnchor: d("2026-08-07T21:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-07T22:00:00-04:00"), settings: settings(mins: 15),
    ...
    func testIdleDisabledNeverFires() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T23:00:00-04:00"), plannedStopAnchor: d("2026-08-07T21:00:00-04:00"),
    ...
    func testPlannedStopBeforeDeadline() {
        ...
        let a = SessionCompletionMonitor.decide(now: d("2026-08-08T02:59:00-04:00"), plannedStopAnchor: d("2026-08-07T23:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-08T02:58:00-04:00"), settings: settings(planned: true, h: 3, m: 0),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .none)
    }
    func testPlannedStopAtDeadlineFires() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-08T03:00:05-04:00"), plannedStopAnchor: d("2026-08-07T23:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-08T02:58:00-04:00"), settings: settings(planned: true, h: 3, m: 0),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .endSession)
    }
    func testPlannedStopAlreadyFiredStaysNone() {
        let a = SessionCompletionMonitor.decide(now: d("2026-08-08T03:05:00-04:00"), plannedStopAnchor: d("2026-08-07T23:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-08T02:58:00-04:00"), settings: settings(planned: true, h: 3, m: 0),
    ...
    func testBothDueEndSessionWins() {
        ...
        let a = SessionCompletionMonitor.decide(now: d("2026-08-08T03:20:00-04:00"), plannedStopAnchor: d("2026-08-07T23:00:00-04:00"),
    ...
    func testPlannedStopEveningStartDoesNotFireImmediately() {
        ...
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T23:00:30-04:00"), plannedStopAnchor: d("2026-08-07T23:00:00-04:00"),
    ...
    func testPlannedStopLaterSameEvening() {
        ...
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T23:31:00-04:00"), plannedStopAnchor: d("2026-08-07T22:00:00-04:00"),
            lastAcceptedFrame: d("2026-08-07T23:00:00-04:00"), settings: settings(idle: false, planned: true, h: 23, m: 30),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .endSession)
    }

    // --- regression: MID-SESSION enable anchors on armed-at, not sessionStart (P2) ---
    func testPlannedStopMidSessionEnableDoesNotFireImmediately() {
        // Enabled ("armed") at 11:30 PM in a session that started earlier; stop 22:00.
        // Anchored on the 23:30 armed-at, the next occurrence of 22:00 is the NEXT day,
        // so a first tick at 23:30:30 must NOT fire. (Anchored on an earlier sessionStart
        // of 20:00, today's 22:00 would already be past → immediate fire.)
        let a = SessionCompletionMonitor.decide(now: d("2026-08-07T23:30:30-04:00"), plannedStopAnchor: d("2026-08-07T23:30:00-04:00"),
            lastAcceptedFrame: d("2026-08-07T23:29:00-04:00"), settings: settings(idle: false, planned: true, h: 22, m: 0),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .none)
    }
    func testPlannedStopMidSessionEnableFiresNextDay() {
        // Same 23:30 armed-at; the deadline is 22:00 the NEXT day — fires just after it.
        let a = SessionCompletionMonitor.decide(now: d("2026-08-08T22:00:05-04:00"), plannedStopAnchor: d("2026-08-07T23:30:00-04:00"),
            lastAcceptedFrame: d("2026-08-08T21:58:00-04:00"), settings: settings(idle: false, planned: true, h: 22, m: 0),
            safeguardAlreadyFiredThisIdle: false, plannedStopAlreadyFired: false, calendar: cal)
        XCTAssertEqual(a, .endSession)
    }
}
