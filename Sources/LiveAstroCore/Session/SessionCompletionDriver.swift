...
public struct SessionCompletionDriver {
    ...
    public mutating func step(now: Date, plannedStopAnchor: Date, lastAcceptedFrame: Date?, settings: CompletionSettings,
        ...
        let action = SessionCompletionMonitor.decide(
            now: now, plannedStopAnchor: plannedStopAnchor, lastAcceptedFrame: lastAcceptedFrame, settings: settings,
