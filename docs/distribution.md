...
- `dist/LiveAstroStudio-3.0.4.dmg`
...
```bash
Scripts/package_release.sh --dry-run --version 3.0.4 --sign ad-hoc
Scripts/package_release.sh --dry-run --version 3.0.4 --sign developer-id --identity "Developer ID Application: Example (TEAMID)"
Scripts/package_release.sh --dry-run --version 3.0.4 --sign developer-id --identity "Developer ID Application: Example (TEAMID)" --notarize --notary-profile liveastro-notary
```
...
xcrun stapler validate dist/LiveAstroStudio-3.0.4.dmg
```
